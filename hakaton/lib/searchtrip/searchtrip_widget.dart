...
import 'searchtrip_model.dart';
export 'searchtrip_model.dart';
...
class _SearchtripWidgetState extends State<SearchtripWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchtripModel());
  }
