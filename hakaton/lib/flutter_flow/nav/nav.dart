...
class AppStateNotifier extends ChangeNotifier {
  HakatonFirebaseUser? initialUser;
  HakatonFirebaseUser? user;
  ...
  void update(HakatonFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'StartPage')
              : StartPageWidget(),
        ),
        FFRoute(
          name: 'infoaboutuser',
          path: '/infoaboutuser',
          builder: (context, params) => InfoaboutuserWidget(),
        ),
        FFRoute(
          name: 'SearchPage',
          path: '/searchPage',
        ...
        FFRoute(
          ...
          path: '/tripage',
          asyncParams: {
            'trip': getDoc(['trips'], TripsRecord.serializer),
          },
          builder: (context, params) => TripageWidget(
